...
from .server import GatewayCredsMiddleware, create_mcp_server
...
def _build_http_app(mcp, settings):
    ...
    mounted = (
        GatewayCredsMiddleware(mcp_app, settings)
...
def main() -> None:
    ...
    if settings.mcp_transport == "http":
        ...
        print(
            f"bamboohr-mcp server listening on "
        ...
        print("bamboohr-mcp server running on stdio", file=sys.stderr)
